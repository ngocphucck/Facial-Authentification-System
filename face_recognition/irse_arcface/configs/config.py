...
configurations = {
    1: dict(
        ...
        MODEL_ROOT = 'face_recognition/irse_arcface/weights', # the root to buffer your checkpoints
        LOG_ROOT = 'face_recognition/irse_arcface/logs', # the root to log your train/val status
        BACKBONE_RESUME_ROOT = 'face_recognition/irse_arcface/weights/backbone/backbone_ir50_asia.pth', # the root to resume training from a saved checkpoint
