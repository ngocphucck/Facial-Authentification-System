...
from face_recognition.irse_arcface.configs.config import configurations
from face_recognition.irse_arcface.models.backbone.model_irse import IR_50, IR_101, IR_152, IR_SE_50, IR_SE_101, IR_SE_152
from face_recognition.irse_arcface.models.head.metrics import ArcFace, CosFace, SphereFace, Am_softmax
from face_recognition.irse_arcface.losses.focal import FocalLoss
from face_recognition.irse_arcface.utils.utils import make_weights_for_balanced_classes, get_val_data, separate_irse_bn_paras, separate_resnet_bn_paras, warm_up_lr, schedule_lr, perform_val, get_time, buffer_val, AverageMeter, accuracy
...
if __name__ == '__main__':
    ...
    BACKBONE_NAME = cfg['BACKBONE_NAME'] # support: ['IR_50', 'IR_101', 'IR_152', 'IR_SE_50', 'IR_SE_101', 'IR_SE_152']
    ...
    dataset_train = datasets.ImageFolder(os.path.join(DATA_ROOT, 'custom_data'), train_transform)
    ...
    if BACKBONE_RESUME_ROOT and HEAD_RESUME_ROOT:
        ...
        if os.path.isfile(BACKBONE_RESUME_ROOT):# and os.path.isfile(HEAD_RESUME_ROOT):
            ...
            # HEAD.load_state_dict(torch.load(HEAD_RESUME_ROOT, map_location='cpu'))
        else:
    ...
    NUM_EPOCH_WARM_UP = NUM_EPOCH // 15  # use the first 1/15 epochs to warm up
