...
if __name__ == '__main__':
    ...
    parser.add_argument("-root", "--root", help = "specify your dir",default = 'custom_data', type = str)
    parser.add_argument("-min_num", "--min_num", help = "remove the classes with less than min_num samples", default = 6, type = int)
